...
pin_number kSocket1_StepPinNumber           = 29;
pin_number kSocket1_DirPinNumber            = 28;
...
pin_number kSocket2_StepPinNumber           = 31;
pin_number kSocket2_DirPinNumber            = 30;
...
pin_number kSocket3_StepPinNumber           = 27;
pin_number kSocket3_DirPinNumber            = 26;
...
pin_number kSocket4_StepPinNumber           = 23;
pin_number kSocket4_DirPinNumber            = 22;
...
pin_number kSocket5_StepPinNumber           = 25;
pin_number kSocket5_DirPinNumber            = 24;
...
// Moteur Gestion enroulement plastique 
pin_number kSocket6_SPISlaveSelectPinNumber = -1;
pin_number kSocket6_InterruptPinNumber      = -1;
pin_number kSocket6_StepPinNumber           = 33;
pin_number kSocket6_DirPinNumber            = 32;
...
pin_number kOutput1_PinNumber = 20;  
pin_number kOutput2_PinNumber = 39;  // Laser
pin_number kOutput3_PinNumber = 40;  // Needle
pin_number kOutput4_PinNumber = 41;  // Vacuum1
pin_number kOutput5_PinNumber = 42;  // Blow1

pin_number kOutput6_PinNumber  = 43;  // Blow2
pin_number kOutput7_PinNumber  = 44;  // Vacuum2
pin_number kOutput8_PinNumber  = 34;  // CMD PUMP  
pin_number kOutput9_PinNumber  = 14;  
pin_number kOutput10_PinNumber = 20;  

pin_number kOutput11_PinNumber = 9;  
...
pin_number kInput1_PinNumber = 37;  // Vaccum1
pin_number kInput2_PinNumber = 38;  // Caccum2
pin_number kInput3_PinNumber = 35;  // Input Needle
pin_number kInput4_PinNumber = 36;	// Homing X
pin_number kInput5_PinNumber = 45;  // Homing Y
pin_number kInput6_PinNumber = 15;	

pin_number kInput7_PinNumber  = 21;
pin_number kInput8_PinNumber  = 61;
 ...
 **/
 ...
 pin_number kLED_RGBWPixelPinNumber=63;
